<aside
    ...
    <div class="collapse navbar-collapse  w-auto max-height-vh-90" id="sidenav-collapse-main">
        ...
        <a class="nav-link  " href="../accounting/list.accounting.php">
            ...
            <li class="nav-item">
                <a class="nav-link  " href="../executives/list.exectutive.php">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="far fa-list-alt text-dark" style="height: 12px; width: 12px;"></i>
                    </div>
        ...
        <a class="nav-link  " href="../accounting/add.accounting.php">
            ...
            <li class="nav-item">
            <a class="nav-link  " href="../executives/add.executive.php">
                <div
                    class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-user-plus text-dark"></i>
                </div>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="lists">
                <ul class="nav ms-4 ps-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../executive/list.executives.php">
                            <span class="sidenav-mini-icon"> </span>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="maintenance">
                <ul class="nav ms-4 ps-3">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../executives/add.executives.php">
                            <span class="sidenav-mini-icon text-xs"> </span>
                            <span class="sidenav-normal font-weight-bold">Add Executives</span>
                        </a>
                    </li>
                </ul>
            </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="lists">
                    <ul class="nav ms-4 ps-3">
                        ...
                        <li class="nav-item">
                        <a class="nav-link" href="../executives/list.executives.php">
                            <span class="sidenav-mini-icon"> </span>
                            <span class="sidenav-normal font-weight-bold">Executives List</span>
                        </a>
                    </li>
    ...
    <div class="sidenav-footer mx-3">
        ...
        elseif ($_SESSION['role'] == "Dean") {
          ...
          data-bs-placement="top" title="Edit Account" data-container="body" data-animation="true"><i
                ...
                echo '<a class="btn bg-gradient-light mt-2 mb-3  border-radius-md mx-3" href="../executive/edit.executives.php" data-bs-toggle="tooltip"
                         data-bs-placement="top" title="Personal Info" data-container="body" data-animation="true"><i
                               class="fas fa-user-edit"></i></a>';        
        } ?>
    </div>
