...
?>
<title>
    Enrolled Old Students | SFAC - Bacoor
</title>
</head>
                    ...
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="row d-flex justify-content-center mx-4">
                            <div class="col-md-6 m-1 ">
                                <form method="GET" action="enrolledOldStud.php">
                                ...
                                <tbody>
                                    ...
                                    $studentList = mysqli_query(
                                        ...
                                        "SELECT *,CONCAT(tbl_students.lastname, ', ', tbl_students.firstname, ' ', tbl_students.middlename)  as fullname
                                            ...
                                            WHERE remark IN ('Approved') AND status = 'Old' AND ay_id IN ('$_SESSION[AC]') AND sem_id IN ('$_SESSION[S]') AND
