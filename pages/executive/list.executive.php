...
?>
<title>
    View Executives List | SFAC - Bacoor
</title>
</head>
                    ...
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover nowrap responsive" id="datatable-basic"
                                ...
                                <tbody>
                                    <?php
                                    $listExecutives = mysqli_query($db, "SELECT *, CONCAT(facul.faculty_lastname, ', ', facul.faculty_firstname, ' ', facul.faculty_middlename) AS fullname 
                                            FROM tbl_faculties_staff AS facul");
                                    while ($row = mysqli_fetch_array($listExecutives)) {
                                        $id = $row['faculty_id'];
                                    ?>
