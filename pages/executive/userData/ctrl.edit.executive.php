...
if (isset($_POST['saveImg'])) {
    ...
    if (!empty($_FILES['image']['tmp_name'])) {
        ...
        if ($_SESSION['role'] == "Super Administrator" || $_SESSION['role'] == "Adviser") {
            header("location: ../edit.executives.php?facultyStaff_id=" . $facultyStaff_id);
        } else {
            header("location: ../edit.executives.php");
        }
    } else {
...
if (isset($_POST['save'])) {
    ...
    if ($check == 0) {
        ...
        if ($getID == $facultyStaff_id || $check2 < 1) {
            ...
            if ($_SESSION['role'] == "Super Administrator" || $_SESSION['role'] == "Adviser") {
                header("location: ../edit.ecxectuives.php?facultyStaff_id=" . $facultyStaff_id);
            } else {
                header("location: ../edit.executives.php");
            }
        } else {
        ...
        while ($row = mysqli_fetch_array($checkPass)) {
            ...
            if ($checkHashPass == false) {
                ...
                if ($password == $confirmPass) {
                    ...
                    header("location: ../edit.exectuives.php");
                } else {
